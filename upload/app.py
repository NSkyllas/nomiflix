...
GENRES = ["Samurai", "Science Fiction", "Greek", "Western"]
...
def upload():
    ...
    def error(message):
        return render_template("index.html", error=message, genres=GENRES), 400
    ...
    # Poster/credits, then video, then json last — the watcher triggers off
    ...
    return render_template(
        "index.html", genres=GENRES, success=f'Uploaded — nomiflix will process "{title}" shortly.'
    )
